...
2. Get Audacity rolling.
  ...
  * To configure Audacity, <s>set audio host to JACK, output device to PulseAudio JACK Source, and input device to PulseAudio JACK Sink</s> set audio host to JACK, output device to system, and input device to rakarrack. Don't know where to change these settings? See below.
